...
- [ ] **CIS-01**: The PHPUnit integration matrix is trimmed from 11 lanes to a documented representative subset (full PHP×WP on MS=false, MS=true on one representative combo, MariaDB LTS retained); dropped coverage is explicitly recorded.
