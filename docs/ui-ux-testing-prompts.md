...
- [ ] **Settings page:** 6 help tabs provide contextual reference (Start Here, Modes &amp; Policies, Rule Tester, Incident Response, Security Boundaries, Developers) without leaving the page.
...
- [ ] **Settings page:** 6 help tabs cover the current core operator topics: Start Here, Modes &amp; Policies, Rule Tester, Incident Response, Security Boundaries, Developers.
...
These are quick checks beyond a full WCAG audit. For the resolved accessibility items, see [the archived accessibility audit](archive/accessibility-audit.md).
